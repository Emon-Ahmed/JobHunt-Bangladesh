      ...
      <div className="container">
        ...
        <div className="row align-items-start my-5">
            <div className="col-md-3">
                <div className="profile_setting nav flex-column nav-pills me-3 pb-4" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button className="nav-link active px-5 my-2 text-start" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true"> <span className="pe-2"><FaRegBuilding/></span> My Profile</button>
                    <button className="nav-link px-5 my-2 text-start" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false"> <span className="pe-2"><FaShoppingBag /> </span>Applied Jobs</button>
                    <button className="nav-link px-5 my-2 text-start" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false"> <span className="pe-2"><FaRegUser /></span> My Jobs</button>
                    <button className="nav-link px-5 my-2 text-start" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false"> <span className="pe-2"><FaRegSun /></span> Settings</button>
                </div>
                <hr />
                <p className="text-start py-2 fontSize13 text-danger">Delete Account</p>
            </div>
